...
import { Activity, ShieldAlert, BarChart3, Layers, Database, Cpu, PlayCircle, History, RefreshCw, Zap, Bot, User as UserIcon, LogOut, LogIn, Compass } from 'lucide-react';
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="bg-slate-900/90 border-b border-slate-800 text-slate-100 sticky top-0 z-50 backdrop-blur-md">
      ...
      <div className="max-w-7xl mx-auto px-4 py-2 flex flex-wrap items-center justify-between gap-3 border-b border-slate-800/80">
        ...
        {/* Live Market Price & VIX Ticker */}
        {snapshot && (
          <div className="flex items-center space-x-3 text-[11px] font-mono bg-slate-950 px-3 py-1 rounded border border-slate-800">
            <div>
